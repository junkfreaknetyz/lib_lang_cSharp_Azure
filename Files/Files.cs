...
namespace language.azure.files
{
    public static class Func
    {
        ...
        {
            //
            //  upload file using ShareFileClient.UploaRange
            //  arguments
            //  for azure are
            //  ***************
        ...
        public static void UploadAsync(ConnectionString connection_string,ShareName share_name,FilesDirectory files_directory,FilesName files_name,language.generic.common.io.Directory directory_from,language.generic.common.io.File file_from,language.generic.common.io.PathSeparatore path_separatore)
        {
            ShareClient share_client=new ShareClient(connection_string.Get(),share_name.Get());
            ShareDirectoryClient share_directory_client=share_client.GetDirectoryClient(files_directory.Get());
            ShareFileClient share_file_client=share_directory_client.GetFileClient(files_name.Get());
            ...
            using(FileStream file_stream=File.OpenRead(local_file_path)){
                ...
                share_file_client.Create(file_stream.Length);
                share_file_client.UploadAsync(file_stream);
            }
        }
    }
